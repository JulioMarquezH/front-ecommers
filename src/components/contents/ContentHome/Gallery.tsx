    ...
    <>
      <div className="grid grid-gallety" >
        <div className="grid-item grid-item--width2">
          <img src={photo1} alt="retrato" className='photo' />
          <img src={photo3} alt="retrato" className='photo' />
          <img src={photo5} alt="retrato" className='photo' />
        </div>
        <div className="grid-item grid-item--width2 img-right" >
          <img src={photo2} alt="retrato" className='photo' />
          <img src={photo4} alt="retrato" className='photo' />
          <img src={photo6} alt="retrato" className='photo' />
        </div>
      </div>
      <img src={photo7} alt="retrato" className='photo' />
      <div className='container-h2'>
        <h2 className='landing-h2'>Visual Explorations</h2>
      </div>
      <div className="grid" >
        <div className="grid-item grid-item--width2">
          <img src={photo8} alt="retrato" className='photo' />
          <img src={photo11} alt="retrato" className='photo' />
        </div>
        <div className="grid-item grid-item--width2 img-right" >
          <img src={photo9} alt="retrato" className='photo' />
          <img src={photo12} alt="retrato" className='photo' />
        </div>
        <div className="grid-item grid-item--width2 img-right" >
          <img src={photo10} alt="retrato" className='photo' />
          <img src={photo13} alt="retrato" className='photo' />
        </div>
      </div>
    </>
  );
